...
const DropdownMenu = ({
  ...
  return (
    <div className={`w-full max-w-[166px] z-10 w-${width} `} ref={menuRef}>
      <button
      ...
      {isOpen && !isCheckBox ? (
        <div className="absolute mt-2 flex w-[165px] cursor-pointer flex-col rounded-[3px] bg-white p-4 text-[15px]  drop-shadow-dropDownContent">
